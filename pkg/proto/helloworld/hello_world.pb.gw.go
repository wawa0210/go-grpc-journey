...
var (
	...
	pattern_Greeter_GetCityWeather_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"v1", "citys", "name"}, "", runtime.AssumeColonVerbOpt(true)))
)
